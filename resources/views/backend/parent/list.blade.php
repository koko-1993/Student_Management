            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <a href="{{ url('panel/parent/create') }}" class="btn btn-primary pull-right">Create Parent</a>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('panel/parent/edit/'.$value->id) }}" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                            <a href="{{ url('panel/parent/delete/'.$value->id) }}" onclick="return confirm('Are you sure do you want to delete?');" class="btn btn-danger btn-rounded btn-sm"><span class="fa fa-times"></span></a>
                                            <a href="{{ url('panel/parent/my-student/'.$value->id) }}" class="btn btn-primary btn-sm">My Student</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
