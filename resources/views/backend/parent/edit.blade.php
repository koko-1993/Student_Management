...
@section('content')
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('panel/parent') }}">Home</a></li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                    <input type="text" name="occupation" class="form-control" value="{{ old('occupation',$getRecord->occupation) }}"/>
                                                </div>
